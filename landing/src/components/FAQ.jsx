...
const faqs = [
  ...
  },
  {
    ...
    a: 'Стартер планът поддържа до 2 лекари, Про — до 8. За клиники с повече лекари или множество локации предлагаме индивидуални условия.',
  },
  {
  ...
  {
    q: 'Мога ли да откажа абонамента по всяко време?',
    a: 'Разбира се. Без дългосрочни ангажименти. Ако отмените, достъпът продължава до края на платения период. Данните ви се запазват за 30 дни след отмяната.',
  },
  {
    q: 'Предлагате ли обучение и поддръжка?',
    a: 'Да. Всички планове включват email поддръжка. Про планът включва приоритетна поддръжка. За Клиника план предлагаме онбординг сесия и посветен акаунт мениджър.',
  },
  {
