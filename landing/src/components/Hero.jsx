...
const trustPoints = [
  '21 дни без карта за пробния период',
    ...
    <section className="relative flex items-center bg-gradient-to-br from-slate-950 via-slate-900 to-medical-900 overflow-hidden pt-16 pb-16 sm:pb-20">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="max-w-4xl mx-auto text-center mb-8 sm:mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-medical-500/15 border border-medical-500/25 text-medical-300 text-sm font-medium mb-6">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-bold text-white leading-tight mb-5">
            DentPro: Пълна дигитализация на Вашата практика без излишна сложност.
          </h1>

          <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-3xl mx-auto mb-8">
            Спрете да губите време в търсене на картони и писане в тетрадки. Софтуер, създаден с обратната връзка на{' '}
            <span className="text-white font-semibold">15+ клиники</span>
            , готов за работа за под 5 минути.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <a
              href="#register"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 text-slate-300 hover:text-white text-sm font-medium transition-colors border border-transparent hover:border-white/15 rounded-xl"
            >
        ...
        {/* Social proof — directly under video / beside form visually */}
        <div className="max-w-5xl mx-auto mb-8">
          <div className="rounded-2xl border border-medical-400/25 bg-gradient-to-br from-medical-500/15 to-emerald-900/20 px-5 sm:px-8 py-5 sm:py-6 text-center shadow-lg shadow-medical-900/20">
            <p className="text-slate-200 text-sm sm:text-base leading-relaxed">
              <span className="inline-flex items-center justify-center rounded-lg bg-white/10 text-white font-bold text-xl sm:text-2xl tabular-nums px-3 py-1 mr-2">15+</span>
              зъболекари и регистратори от клиники вече разчитат на DentPro всеки ден — платформата е изградена около реалната им работа.
            </p>
          </div>
        </div>
